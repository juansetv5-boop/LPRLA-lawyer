        ...
        <div className="grid lg:grid-cols-2 gap-16 md:gap-20 items-center">
          ...
          <AnimatedSection animation="slide-in-right" delay={200}>
            <a
              ...
              className="p-6 md:p-12 bg-secondary/30 border border-primary/20 relative group text-center flex flex-col items-center justify-center transition-all hover:border-primary/60 cursor-pointer overflow-hidden w-full block"
            >
              <div className="absolute inset-0 bg-primary/5 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none"></div>

              <div className="mb-6 md:mb-10 relative z-10 w-full">
                <MessageCircle className="h-12 w-12 md:h-16 md:w-16 text-primary mx-auto mb-4 md:mb-6" />
