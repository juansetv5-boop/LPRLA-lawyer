    ...
    <section className="relative min-h-[90vh] flex items-center pt-32 pb-16 overflow-hidden bg-black">
      ...
      <div className="container relative z-10 my-auto">
        <div className="max-w-4xl">
          ...
          <AnimatedSection animation="slide-in-up" delay={250}>
          ...
          <AnimatedSection animation="slide-in-up" delay={550}>
            <div className="flex flex-col md:flex-row gap-4">
              <Button asChild className="gold-metallic-gradient text-black font-black h-14 md:h-16 px-6 md:px-10 rounded-none border-none shadow-2xl shadow-primary/20 hover:scale-[1.02] transition-transform text-base md:text-2xl">
